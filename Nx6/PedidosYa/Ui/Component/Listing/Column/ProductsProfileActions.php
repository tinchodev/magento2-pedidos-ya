    ...
    public function prepareDataSource(array $dataSource): array
    {
        ...
        foreach ($dataSource['data']['items'] as &$item) {
            ...
            $item[$this->getData('name')] = [
                'edit' => [
                    'href' => $this->urlBuilder->getUrl(self::URL_PATH_EDIT, ['id' => $item['products_profile_id']]),
                    'label' => __('Edit'),
                ],
                'run' => [
                    'href' => $this->urlBuilder->getUrl(self::URL_PATH_RUN, ['id' => $item['products_profile_id']]),
                    'label' => __('Run Now'),
                    'confirm' => [
                        'title' => __('Run Export'),
                ...
                'delete' => [
                    'href' => $this->urlBuilder->getUrl(self::URL_PATH_DELETE, ['id' => $item['products_profile_id']]),
                    'label' => __('Delete'),
                    'confirm' => [
